...
public class practice extends Base {
	...
	private void test1() throws InterruptedException, Exception {
		...
		fillTextBox(lo.getTxtusername(), getdata("frames", "Datas", 1, 0));
		fillTextBox(lo.getTxtpassword(), getdata("frames", "Datas", 1, 1));
		...
		fillTextBox(lo.getBtnClickDateIn(), getdata("frames", "Datas", 1, 2));
		
	    lo.getBtnClickDateOut().clear();
	    fillTextBox(lo.getBtnClickDateOut(), getdata("frames", "Datas", 1, 3));
	    ...
	    fillTextBox(lo.getTxtNameFirst(), getdata("frames", "Datas", 1, 4));
	    
	    fillTextBox(lo.getTxtNameLast(), getdata("frames", "Datas", 1, 5));
	    
	    fillTextBox(lo.getTxtAddress(), getdata("frames", "Datas", 1, 6) );
	    
	    fillTextBox(lo.getTxtCard(), getdata("frames", "Datas", 1, 7));
	    ...
	    fillTextBox(lo.getTxtcvv1(), getdata("frames", "Datas", 1, 8));
	  ...
	  getCellCreate("frames", "Datas", 1, 10, st);
	  System.out.println("---------------");
